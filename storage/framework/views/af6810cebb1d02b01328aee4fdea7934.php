<?php $__env->startSection('title', 'The Search'); ?>

<?php $__env->startSection('content'); ?>

    <!-- ===== :: Main Menu ==== :: -->
    <?php echo $__env->make('frontend.partials.main-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ===== :: Main Menu ==== :: -->
    ...
    <section class="banner--wrapper">
        <div class="container">
            <div class="banner--heading">
                ...
                <?php $__currentLoopData = $challenges->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <p class="subHeading">
                        Commit to consistency, reshape your body, and compete for a
                        <span> $<?php echo e(number_format($challenge->price_money)); ?></span> prize.
                    </p>
            ...
            <div class="banner--btn">
                <a class="learn--moreBtn" href="<?php echo e(route('challenge')); ?>">Learn More</a>

                <?php if(Auth::check() && Auth::user()->challengeSubscribers): ?>
                    <a class="register--Btn" href="<?php echo e(route('user.dashboard')); ?>">Go To Dashboard</a>
                <?php else: ?>
                    <a class="register--Btn" href="<?php echo e(route('register')); ?>">Register Now</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    >
            ...
            >
                <?php $__currentLoopData = $challenges->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="timeSection--heading">
                        ...
                        <p class="timeSectionSub two">
                            ...
                            <span> <?php
                                ...
                                <?php if($diffInMonths >= 1): ?>
                                    <?php echo e($diffInMonths); ?> <?php echo e($diffInMonths == 1 ? '-Month' : '-Months'); ?>

                                <?php else: ?>
                                    <?php echo e($diffInDays); ?> -Days
                                <?php endif; ?> </span> Transformation Challenge isn’t just about
                    ...
                    <div class="duration--Time--wrapper">
                        ...
                        <div class="duration--Time--item">
                            ...
                            <div class="duration--icon--wrapper">
                                ...
                                <span class="duration--text">$<?php echo e($challenge->entry_fee ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="duration--Time--item">
                            ...
                            <div class="duration--icon--wrapper">
                                ...
                                <span class="duration--text"><?php echo e(number_format($challenge->price_money) ?? 'N/A'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        ...
                        const challengeStartDate = "<?php echo e($challenge->start_date); ?>";
        ...
        <div class="timeSection--freme--upper">
            <img src="<?php echo e(asset('/frontend/assets/images/timeSectionFreame.png')); ?>" alt="not found" />
        </div>
    </section>
        ...
        <div class="container">
            <div class="member--with--benifits--main">
                ...
                <div class="member--with--benifits--img">
                    <img src="<?php echo e(asset('/frontend/assets/images/StarIcon.png')); ?>" alt="not found" />
                </div>
            ...
            <div class="studio--luxury--main--wrapper">
                <div class="studio--luxury--left--item">
                    <div class="studio--luxury--left--item--img">
                        <img
                            src="<?php echo e(asset('/frontend/assets/images/StudioLuxeryItem.png')); ?>"
                            alt="not found"
                        />
                    </div>
                ...
                <div class="studio--luxury--right--item">
                    <div class="studio--luxury--left--item--img--two">
                        <img
                            src="<?php echo e(asset('/frontend/assets/images/studioLexuryItem2.png')); ?>"
                            alt="not found"
                        />
                    </div>
                    <div class="studio--luxury--left--item--text">
        ...
        <div class="container">
            <div class="join--now--main--wrapper">
                ...
                <div class="join--now--main--right">
                    <img src="<?php echo e(asset('/frontend/assets/images/joinNowBanner.png')); ?>" alt="not found" />
            ...
            <?php $__currentLoopData = $challenges->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="affordable--heading">
                    ...
                    <p class="timeSectionSub">
                        Get ready to unlock your potential. For just <span> $<?php echo e($challenge->entry_fee ?? 0); ?></span>,
                        ...
                        <?php else: ?>
                            <?php echo e($diffInDays); ?> Days
                        <?php endif; ?> journey designed to help you <br />
                ...
                <div class="challangeName--wrapper">
                    <div class="challangeName--item1">
                        <h3 class="challangeTexts"><?php echo e($challenge->name); ?></h3>

                        <h4 class="duration--day--text--italic">
                            <?php echo e($challenge->entry_fee ?? 'N/A'); ?> <span>/For the tournament time</span>
                        </h4>
                    </div>

                    <div class="challangeName--item2">
                        <div class="challangeName--itemInner">
                            <?php $__currentLoopData = $challenge->challengeRules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(Auth::check()): ?>
                        ...
                        <?php else: ?>
                            <div class="challangeName--item3">
                                <form action="<?php echo e(route('stripe.checkout')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>

                                    <input type="hidden" name="challenge_id" value="<?php echo e($challenge->id); ?>">
                    ...
                    <?php else: ?>
                        <div class="challangeName--item3">
                            <a class="register--Btn" href="<?php echo e(route('register')); ?>">Purchase Join Ticket</a>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Herd\Softvence\Projects\david_heizt\resources\views/frontend/layouts/pages/home.blade.php ENDPATH**/ ?>