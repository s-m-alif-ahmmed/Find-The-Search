(() => {
    "use strict";
    $(function(e) {
        var a = document.getElementById("echart1"),
            t = [
        ...
        var n = [{
            ...
            r = document.getElementById("echart2"),
            l = echarts.init(r),
            s = {
                grid: { top: "6", right: "0", bottom: "17", left: "25" },
                xAxis: {
        ...
        var c = document.getElementById("echart3"),
            d = {
        ...
        var f = document.getElementById("echart4"),
            m = {
                grid: { top: "6", right: "0", bottom: "17", left: "32" },
                xAxis: {
                    type: "value",
        ...
        var g = document.getElementById("echart5"),
            p = [{
                    name: "sales",
                    type: "bar",
                    stack: "Stack",
        ...
        var u = document.getElementById("echart6"),
            L = {
        ...
        var v = document.getElementById("echart7"),
            z = {
                grid: { top: "6", right: "0", bottom: "17", left: "25" },
                xAxis: {
                    data: [
        ...
        var A = document.getElementById("echart8");
        (D = echarts.init(A)).setOption({
                title: { text: "Total Sales", left: "center" },
        ...
        for (var E = [], O = 0; O < 5; ++O)
            E.push(Math.round(200 * Math.random()));
        var D,
            B = {
                xAxis: {
                    max: "dataMax",
            ...
            I = document.getElementById("echart9");

        function M() {
            for (var e = 0; e < E.length; ++e)
                Math.random() > 0.9 ?
                (E[e] += Math.round(2e3 * Math.random())) :
                (E[e] += Math.round(200 * Math.random()));
            D.setOption({
                series: [{
                    realtimeSort: !0,
                    name: "Data",
        ...
        for (var k = [], C = [], U = [], F = 0; F < 100; F++)
            k.push("A" + F),
            C.push(5 * (Math.sin(F / 5) * (F / 5 - 10) + F / 6)),
            U.push(5 * (Math.cos(F / 5) * (F / 5 - 10) + F / 6));
        var P = {
            ...
            T = document.getElementById("echart10"),
            X = echarts.init(T);
        X.setOption(P),
            window.addEventListener("resize", function() {
                X.resize();
            });
        var J = document.getElementById("echart11"),
            R = echarts.init(J);
        R.setOption({
                tooltip: { trigger: "item" },
