    ...
    <section class="sign--in--wrapper">
        <div class="sign--in--wrapper--main">
            ...
            <div class="sign--in--form">
                <form class="form--wrapper" action="{{ route('password.store') }}" method="POST">
                    @csrf

                    <div>
                        <h3 class="signIn--form--texts">Change Password</h3>
                    </div>
                    ...
                    <div class="signIn--inputBox--main">
                        ...
                        <div>
                            <label class="emai--input--box--text--wrapper" for="Password">
                                <div class="passWord--hidden--Text--wrapper">
                                    <h6 class="email--address--texts">New Password</h6>
                        ...
                        <div>
                            <label class="emai--input--box--text--wrapper" for="Password">
                                ...
                                <div class="email--inputBox--wrapper">
                                    <input id="confirm-password" autocomplete="new-password" name="password_confirmation" min="8" type="password" />
                                </div>
                            </label>
                    ...
                    <div class="signIn--Btn--wrapper two">
                        <button type="submit" class="passDirectionText">Save </button>
                    </div>
