...
@section('title', 'Sign In - The Search')
        ...
        <div class="sign--in--wrapper--main">
            ...
            <div class="sign--in--form">
                <form class="form--wrapper"  action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        <h3 class="signIn--form--texts">Welcome Back</h3>
                    </div>
                    ...
                    <div class="signIn--inputBox--main">
                        ...
                        <div>
                            ...
                            @enderror
                            <h6 class="passDirectionText">Use 8 or more characters with a mix of letters, numbers & symbols</h6>
                        </div>

                        <div class="checkBox--wrapper">
                            <label for="TermsCondition">
                                <input id="TermsCondition" name="terms_and_policy" value="1" type="checkbox">
                                <span class="email--address--texts" href="#">By creating an account, I agree to our  <span>Terms of use</span> and <span> Privacy Policy</span></span>
                            </label>
                        </div>
                    ...
                    <div class="signIn--Btn--wrapper">
                        ...
                        <a class="passDirectionText" href="{{ route('register') }}">Don’t have an account? <span>Sign Up</span></a>
                    </div>
